...
function dengue_4st!(x, par, t) 
    ...
    dEh3 = Eh3_trans[1] + new_Eh3
    dEh4 = Eh4_trans[1] + new_Eh4
    dIh1 = Ih1_trans[1] + Eh1_trans[3]
    dIh2 = Ih2_trans[1] + Eh2_trans[3]
    dIh3 = Ih3_trans[1] + Eh3_trans[3]
    dIh4 = Ih4_trans[1] + Eh4_trans[3]
    dRh1 = Rh1_trans[1] + Ih1_trans[3]
    dRh2 = Rh2_trans[1] + Ih2_trans[3]
    dRh3 = Rh3_trans[1] + Ih3_trans[3]
    dRh4 = Rh4_trans[1] + Ih4_trans[3]
    dSh1 = Sh1_trans[1] + Rh1_trans[3]
    dSh2 = Sh2_trans[1] + Rh2_trans[3]
    dSh3 = Sh3_trans[1] + Rh3_trans[3]
    dSh4 = Sh4_trans[1] + Rh4_trans[3]
    
    dEh12 = Eh12_trans[1] + new_Eh12 
    dEh13 = Eh13_trans[1] + new_Eh13 
    dEh14 = Eh14_trans[1] + new_Eh14 
    dEh21 = Eh21_trans[1] + new_Eh21
    dEh23 = Eh23_trans[1] + new_Eh23
    dEh24 = Eh24_trans[1] + new_Eh24
    dEh31 = Eh31_trans[1] + new_Eh31
    dEh32 = Eh32_trans[1] + new_Eh32
    dEh34 = Eh34_trans[1] + new_Eh34
    dEh41 = Eh41_trans[1] + new_Eh41
    dEh42 = Eh42_trans[1] + new_Eh42
    dEh43 = Eh43_trans[1] + new_Eh43
    
    dIh12 = Ih12_trans[1] + Eh12_trans[3]
    dIh13 = Ih13_trans[1] + Eh13_trans[3]
    dIh14 = Ih14_trans[1] + Eh14_trans[3]
    dIh21 = Ih21_trans[1] + Eh21_trans[3]
    dIh23 = Ih23_trans[1] + Eh23_trans[3]
    dIh24 = Ih24_trans[1] + Eh24_trans[3]
    dIh31 = Ih31_trans[1] + Eh31_trans[3]
    dIh32 = Ih32_trans[1] + Eh32_trans[3]
    dIh34 = Ih34_trans[1] + Eh34_trans[3]
    dIh41 = Ih41_trans[1] + Eh41_trans[3]
    dIh42 = Ih42_trans[1] + Eh42_trans[3]
    dIh43 = Ih43_trans[1] + Eh43_trans[3]
    
    dRh12 = Rh12_trans[1] + Ih12_trans[3]
    dRh13 = Rh13_trans[1] + Ih13_trans[3]
    dRh14 = Rh14_trans[1] + Ih14_trans[3]
    dRh21 = Rh21_trans[1] + Ih21_trans[3]
    dRh23 = Rh23_trans[1] + Ih23_trans[3]
    dRh24 = Rh24_trans[1] + Ih24_trans[3]
    dRh31 = Rh31_trans[1] + Ih31_trans[3]
    dRh32 = Rh32_trans[1] + Ih32_trans[3]
    dRh34 = Rh34_trans[1] + Ih34_trans[3]
    dRh41 = Rh41_trans[1] + Ih41_trans[3]
    dRh42 = Rh42_trans[1] + Ih42_trans[3]
    dRh43 = Rh43_trans[1] + Ih43_trans[3]
